...
package com.tg.forgebackroomsplus.item;
...
import com.tg.forgebackroomsplus.item.inventory.AlmondPocketInventoryCapability;

public class AlmondPocketItem extends Item {
	public AlmondPocketItem() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Almond Water Pocket");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new InvMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new AlmondPocketInventoryCapability();
	}
