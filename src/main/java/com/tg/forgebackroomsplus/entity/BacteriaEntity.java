...
package com.tg.forgebackroomsplus.entity;
...
public class BacteriaEntity extends Monster {
	public BacteriaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ForgeBackroomsPlusModEntities.BACTERIA.get(), world);
	}

	public BacteriaEntity(EntityType<BacteriaEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(1f);
		xpReward = 0;
		setNoAi(false);
