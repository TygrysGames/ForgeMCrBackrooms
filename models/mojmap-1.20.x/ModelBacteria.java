...
public class ModelBacteria<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "bacteria"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition torso = partdefinition.addOrReplaceChild("torso", CubeListBuilder.create().texOffs(23, 4).addBox(
				-2.0F, -16.5F, -1.0F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition cube_r1 = torso.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(8, 15).addBox(-5.3738F, 0.5757F, -2.8498F, 7.0F, 1.0F, 1.0F,
		...
		PartDefinition cube_r8 = left_leg.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(20, 24).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 8.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r9 = left_leg.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(24, 24).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 8.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r10 = left_leg.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(28, 31).addBox(-0.5F, -8.0F, -0.5F, 1.0F, 8.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r11 = left_leg.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(32, 6).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 8.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5F, 8.0F, 0.0F, -0.0843F, 0.2971F, -0.1368F));

		PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg",
				CubeListBuilder.create().texOffs(15, 18).addBox(-2.0F, 15.0F, -1.0F, 1.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.0F, 8.0F, -0.5F, 0.0F, 0.0F, -0.2182F));

		PartDefinition cube_r12 = right_leg.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, -8.0F, -0.5F, 1.0F, 8.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5F, 8.0F, 0.0F, -3.1333F, 0.4316F, 3.1361F));

		PartDefinition cube_r13 = right_leg.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(4, 0).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 8.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5F, 8.0F, 0.0F, -2.9931F, 0.1355F, -3.0096F));

		PartDefinition cube_r14 = right_leg.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(8, 23).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 8.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5F, 8.0F, 0.0F, 3.1155F, 0.1355F, -3.0096F));

		PartDefinition cube_r15 = right_leg.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(12, 23).addBox(-0.5F, -8.0F, -0.5F, 1.0F, 8.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5F, 8.0F, 0.0F, 0.0112F, 0.0028F, 0.1795F));

		PartDefinition cube_r16 = right_leg.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(16, 24).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 8.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5F, 8.0F, 0.0F, -0.0843F, 0.2971F, -0.1368F));

		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -5.0F, -0.5F, 0.0F, 0.0F, -0.2618F));

		PartDefinition cube_r17 = left_arm.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(28, 10).addBox(-0.5604F, 0.0F, -0.5F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r18 = left_arm.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(28, 13).addBox(-0.5604F, 0.0F, -0.5F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r19 = left_arm.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(8, 32).addBox(-0.5604F, 0.0F, -0.5F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(11.5F, 21.0F, 0.5F, -0.48F, 0.0F, -0.48F));

		PartDefinition cube_r20 = left_arm
				.addOrReplaceChild("cube_r20",
						CubeListBuilder.create().texOffs(4, 15).addBox(0.0F, 0.0F, 0.0F, 1.0F, 24.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.48F));

		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-2.0F, -5.0F, -0.5F, 0.0F, 0.0F, 1.309F));

		PartDefinition cube_r21 = right_arm.addOrReplaceChild("cube_r21",
				CubeListBuilder.create().texOffs(16, 2).addBox(-0.5604F, 0.0F, -0.5F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(11.5F, 21.0F, 0.5F, 3.0872F, -0.6361F, -2.3041F));

		PartDefinition cube_r22 = right_arm.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(8, 17).addBox(-0.5604F, 0.0F, -0.5F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(11.5F, 21.0F, 0.5F, 0.5965F, -0.1373F, -1.0122F));

		PartDefinition cube_r23 = right_arm.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(15, 17).addBox(-0.5604F, 0.0F, -0.5F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(11.5F, 21.0F, 0.5F, -0.48F, 0.0F, -0.48F));

		PartDefinition cube_r24 = right_arm
				.addOrReplaceChild("cube_r24",
						CubeListBuilder.create().texOffs(0, 15).addBox(0.0F, 0.0F, 0.0F, 1.0F, 24.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.48F));
